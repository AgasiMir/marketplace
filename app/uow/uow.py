...
from app.domains.cart_items.repository import CartItemsRepository
...
class DBManager:
    ...
    Атрибуты:
        ...
        cart_items (CartItemsRepository): Репозиторий для работы с корзиной
        orders (OrderRepository): Репозиторий для работы с заказами
    """
